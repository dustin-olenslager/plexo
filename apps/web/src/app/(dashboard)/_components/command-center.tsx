    ...
    return (
        <div className="flex flex-col gap-6 pb-20 md:pb-4">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 flex flex-col gap-6 xl:min-h-[350px]">
                    {/* Attention Required */}
                    {hasAttention && (
                ...
                <div className="xl:col-span-1 h-[400px] xl:h-auto xl:relative">
                    <div className="rounded-xl border border-zinc-800/60 bg-zinc-900/40 backdrop-blur-sm shadow-sm flex flex-col h-full overflow-hidden xl:absolute xl:inset-0">
