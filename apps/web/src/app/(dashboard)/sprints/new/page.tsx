...
export default function NewSprintPage() {
    ...
    return (
        <div className="mx-auto max-w-2xl">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-xl font-bold text-zinc-50">New Sprint</h1>
                <p className="mt-0.5 text-sm text-zinc-500">
                    Describe a change. The planner breaks it into parallel tasks across branches.
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <p className="text-[11px] text-zinc-600">
                        Must match a GitHub repository you have access to via <code className="text-zinc-500">GITHUB_TOKEN</code>.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    />
                    <p className="text-[11px] text-zinc-600">
                        Be specific. The planner uses this to decompose work and identify parallelism opportunities.
                    </p>
                </div>
                ...
                <div className="rounded-lg border border-zinc-800/60 bg-zinc-900/30 p-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2">How sprints work</p>
                    <ol className="flex flex-col gap-1.5">
                        {[
                            'Claude analyzes your request and repo structure',
                            'Decomposes into parallel tasks with scoped branches',
                            'Tasks execute simultaneously via the agent executor',
                            'Draft PRs are opened on completion; conflicts flagged',
                        ].map((step, i) => (
                    ...
                    >
                        {isPending ? (
                            ...
                            <>
                                ...
                                {form.autoRun ? 'Create & Run Sprint' : 'Create Sprint'}
                            </>
                        )}
                    </button>
                    <button
